...
class Spectrogrammer:
    ...
    class StringToCharImages:
        ...
        def __init__(
            ...
            font=ImageFont.truetype(
                "FiraCode-Regular.ttf", size=FONT_SIZE
    ...
    def convert_to_sound(self, bytes_to_convert, wav_file):
        ...
        wavio.write(wav_file, audio, SAMPLE_RATE, scale="none", sampwidth=2)

    def extract_from_sound(self, wav_file):
        """Extract base64 encoded bytes from an audio file's spectrogram."""
        data = wavio.read(wav_file).data.flatten()
